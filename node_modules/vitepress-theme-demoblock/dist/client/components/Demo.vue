...
<style scoped>
:global(.vp-doc .demoblock div[class*=language-]){border-radius:0!important}:global(.highlight div[class*=language-]){margin:0!important}.demoblock{border:1px solid var(--demoblock-border);border-radius:3px;margin:10px 0;transition:.2s;--demoblock-op-btn-color:#909399;--demoblock-op-btn-hover-color:#303133}html.dark .demoblock{--demoblock-op-btn-color:#a3a6ad;--demoblock-op-btn-hover-color:#e5eaf3}.demoblock-view{box-sizing:border-box;overflow:auto;padding:24px;transition:.2s}.demoblock-divider{position:relative}.demoblock-divider--horizontal{border-top:1px solid var(--demoblock-border);display:block;height:1px;width:100%}.demoblock-op-btns{align-items:center;display:flex;height:40px;justify-content:flex-end;padding:8px}.demoblock-op-btn{color:var(--demoblock-op-btn-color);cursor:pointer;font-size:16px;margin:0 .5rem;transition:.2s}.demoblock-op-btn:hover{color:var(--demoblock-op-btn-hover-color)}.demoblock-source{overflow:hidden}.demoblock-control{align-items:center;background-color:var(--demoblock-control-bg);border-bottom-left-radius:4px;border-bottom-right-radius:4px;border-top:1px solid var(--demoblock-border);bottom:0;box-sizing:border-box;color:var(--demoblock-control);cursor:pointer;display:flex;height:44px;justify-content:center;left:0;margin-top:-1px;position:sticky;right:0;z-index:10}.demoblock-control .control-icon{display:inline-block;font-size:18px}.demoblock-control .control-text{font-size:14px;margin-left:10px}.demoblock-control:hover{color:var(--vp-c-brand)}
</style>
